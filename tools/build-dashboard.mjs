...
function sidebar(activeFile) {
  ...
  s.push(
    '<a class="nav-logo" href="index.html"><span class="monogram"><span>R</span></span><span class="word"><b>ROYALE</b><small style="display:block;font-size:.52rem;letter-spacing:.4em;color:var(--gold)">MANAGEMENT</small></span></a>',
  );
  s.push(
    '<button class="sd-collapse" data-sidebar-collapse aria-label="Collapse sidebar"><i class="fa-solid fa-chevron-left"></i></button>',
  );
  s.push("</div>");
  ...
  s.push(
    "<b>Need a hand?</b><p>The command centre learns from every sale across the maison.</p>",
  );
  s.push(
    '<a class="btn btn-gold btn-sm w-100" href="../pages/contact.html"><i class="fa-solid fa-headset"></i> Concierge Desk</a>',
  );
  s.push("</div></div>");
  s.push("</aside>");
  return s.join("\n");
...
function header() {
  ...
  s.push(
    '<button class="dh-burger d-lg-none" id="mobileBurger" aria-label="Open menu"><i class="fa-solid fa-bars"></i></button>',
  );
  s.push(
    '<div class="dash-search-box"><i class="fa-solid fa-magnifying-glass"></i>',
  );
  s.push(
    '<input id="dashGlobalSearch" type="search" placeholder="Search the command centre\u2026" aria-label="Global search"></div>',
  );
  s.push('<div class="dh-spacer"></div>');
  s.push(
    '<div class="dash-date-selector" role="button" tabindex="0"><i class="fa-solid fa-calendar"></i><span class="js-date-label">This week</span></div>',
  );
  s.push(
    '<button class="dash-icon-btn" data-notif-toggle aria-label="Notifications"><i class="fa-solid fa-bell"></i><span class="dib-badge">3</span></button>',
  );
  s.push('<div class="dropdown">');
  s.push(
    '<button class="dash-icon-btn" data-bs-toggle="dropdown" aria-label="Messages"><i class="fa-solid fa-envelope"></i><span class="dib-badge">2</span></button>',
  );
  s.push('<div class="dropdown-menu dropdown-menu-end dash-dropdown dd-msgs">');
  s.push(
    '<div class="dd-head"><b>Messages</b><a href="messages.html">View all</a></div>',
  );
  s.push(
    '<a class="dd-item" href="messages.html"><span class="dd-ic unread"><i class="fa-solid fa-user"></i></span><span><b>Charlotte M.</b><p>Private preview request \u2014 Saturday?</p></span><time>2m</time></a>',
  );
  s.push(
    '<a class="dd-item" href="messages.html"><span class="dd-ic unread"><i class="fa-solid fa-user"></i></span><span><b>Henri S.</b><p>Lost &amp; found: leather tote, Level 1</p></span><time>1h</time></a>',
  );
  s.push(
    '<div class="dd-foot"><a href="messages.html" class="btn btn-ghost btn-sm">Open inbox</a></div>',
  );
  s.push("</div></div>");
  s.push('<div class="dropdown">');
  s.push(
    '<div class="dash-profile" role="button" tabindex="0"><span class="dp-avatar">AB</span><span><span class="dash-name">Alex Beaumont</span><span class="dash-role">General Manager</span></span></div>',
  );
  s.push('<div class="dropdown-menu dropdown-menu-end profile-dd">');
  s.push(
    '<a class="dropdown-item" href="settings.html"><i class="fa-solid fa-user-pen"></i> My profile</a>',
  );
  s.push(
    '<a class="dropdown-item" href="settings.html"><i class="fa-solid fa-gear"></i> Preferences</a>',
  );
  s.push(
    '<a class="dropdown-item" href="../index.html"><i class="fa-solid fa-building"></i> View public site</a>',
  );
  s.push("</div></div>");
  s.push('<div class="dropdown">');
  s.push(
    '<button class="btn btn-add btn-sm qa-btn" data-bs-toggle="dropdown" aria-label="Quick actions"><i class="fa-solid fa-plus"></i> Quick Action</button>',
  );
  s.push('<div class="dropdown-menu dropdown-menu-end qa-menu">');
  s.push(
    '<a class="dropdown-item" href="stores.html"><i class="fa-solid fa-store"></i> Add store</a>',
  );
  s.push(
    '<a class="dropdown-item" href="products.html"><i class="fa-solid fa-shirt"></i> Add product</a>',
  );
  s.push(
    '<a class="dropdown-item" href="events.html"><i class="fa-solid fa-calendar"></i> Add event</a>',
  );
  s.push(
    '<a class="dropdown-item" href="offers.html"><i class="fa-solid fa-tag"></i> Create offer</a>',
  );
  s.push("</div></div>");
  s.push("</header>");
  return s.join("\n");
...
const CONFIRM =
  '<div class="modal fade dash-modal" id="confirmModal" tabindex="-1" aria-hidden="true">' +
...
function shell(name, opts) {
  ...
  s.push(
    '<meta name="description" content="Maison Royale management dashboard — ' +
      opts.title +
      '.">',
  );
  ...
  s.push(
    '<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Manrope:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">',
  );
  s.push(
  ...
  s.push("</div>");
  s.push(
    '<footer class="dash-footer-bar"><span>Maison Royale \u2014 Command Centre</span><span>\u00A9 <span class="js-dash-year">2026</span> Maison Royale</span></footer>',
  );
  s.push("</div></div>");
...
function pageTitle(icon, title, sub, btn) {
  return (
    '<div class="dash-page-title"><div><h1>' +
    title +
    "</h1><p>" +
    sub +
    "</p></div>" +
...
// ============================ DASHBOARD INDEX ============================
const dashWelcome =
  '<div class="dash-welcome"><div><h2>Good evening, Alex</h2>' +
...
const indexContent =
  dashWelcome +
  '<div class="kpi-stats-row" style="margin:-10px 0 22px">' +
...
function textField(label, id, ph, required) {
  return (
    '<div class="form-group"><label class="form-label" for="' +
    id +
    '">' +
    label +
    "</label>" +
    ...
    '><span class="error-msg">Required field.</span></div>'
  );
}
...
function selField(label, id, optsArr, val) {
  ...
  return (
    ...
    '" required>' +
    opts +
    '</select><span class="error-msg">Required field.</span></div>'
  );
}
function areaField(label, id, rows) {
  return (
    '<div class="col-span-2 form-group"><label class="form-label" for="' +
    id +
    '">' +
    label +
    "</label>" +
...
function dateField(label, id) {
  return (
    ...
    '<input class="form-control" id="' +
    id +
    '" type="date" required><span class="error-msg">Required field.</span></div>'
  );
}
function imgField(id) {
  return (
    ...
    id +
    '">Image Key</label>' +
    '<input class="form-control js-img-input" id="' +
    id +
    '" placeholder="e.g. retailStorefront, dressA, diningA\u2026">' +
...
function crudShell(titleId, labelId, saveId, bodyHtml, modalId) {
  return (
    '<div class="modal fade dash-modal" id="' +
    (modalId || "crudModal") +
...
function dataTable(id, theadCols, cols) {
  const th = theadCols
    ...
    .join("");
  return (
    '<div class="panel"><div class="table-responsive-lux"><table class="data-table" id="' +
    id +
    '"><thead><tr>' +
    th +
    "</tr></thead>" +
    '<tbody id="' +
    id.replace("Table", "Tbody") +
    '"></tbody></table></div><div class="pagination-lux" id="' +
    id.replace("Table", "Pager") +
    '"></div></div>'
  );
}
...
const storesContent =
  ...
  dataTable(
    "storesTable",
    ["Store", "Category", "Floor", "Status", "Opening Hours", "Actions"],
    ["name", "cat", "floor", "status", "hours", ""],
  ) +
  crudShell(
    "crudModalTitle",
    "crudSubmitLabel",
...
const productsContent =
  ...
  crudShell(
    ...
    textField("Product Name", "prName", "Noir Gown \u2014 Haute Couture") +
      ...
      imgField("prImg") +
      areaField("Description", "prDesc", 3),
    "productModal",
  );
...
const eventsContent =
  ...
  dataTable(
    "eventsTable",
    ["Event", "Date", "Location", "Capacity", "Status", "Actions"],
...
const offersContent =
  ...
  dataTable(
    "offersTable",
    ["Offer", "Store", "Discount", "Start", "Ends", "Status", "Actions"],
    ["title", "store", "discount", "start", "end", "status", ""],
  ) +
  crudShell(
    "crudModalTitle",
    "crudSubmitLabel",
...
function miniTable(theadCols, id) {
  return (
    '<div class="panel"><div class="table-responsive-lux"><table class="data-table"><thead><tr>' +
    theadCols
      .map(function (c) {
        return "<th>" + c + "</th>";
      })
...
const brandsContent =
  ...
  miniSearch +
  miniTable(["Brand", "Category", "Floor", "Status", "Actions"], "brandsBody");
...
const categoriesContent =
  ...
  miniSearch +
  miniTable(
    ["Category", "Department", "Boutiques", "Status", "Actions"],
    "catBody",
  );
...
const restaurantsContent =
  ...
  miniSearch +
  miniTable(
    ["Restaurant", "Cuisine", "Level", "Price", "Hours", "Status", "Actions"],
    "restBody",
  );
...
const bookingsContent =
  ...
  miniSearch +
  miniTable(
    ["Booking", "Guest", "Venue", "Date", "Guests", "Status", "Actions"],
    "bookBody",
  );
...
const messagesContent =
  ...
  miniSearch +
  miniTable(["Guest", "Subject", "Received", "Status", "Actions"], "msgBody");
const FLT = `
...
write("brands", {
  ...
  inline: FLT + brandsInline,
});
write("categories", {
  title: "Categories",
  content: categoriesContent,
  inline: FLT + categoriesInline,
});
write("restaurants", {
  title: "Restaurants",
  content: restaurantsContent,
  inline: FLT + restaurantsInline,
});
write("customers", {
  title: "Customers",
  content: customersContent,
  inline: FLT + customersInline,
});
write("bookings", {
  title: "Bookings",
  content: bookingsContent,
  inline: FLT + bookingsInline,
});
write("messages", {
  title: "Messages",
  content: messagesContent,
  inline: FLT + messagesInline,
});
write("analytics", {
  title: "Analytics",
